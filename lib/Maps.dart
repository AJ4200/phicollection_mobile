...
import 'PC Driver/PCDriverScanQR.dart';
              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: <Widget>[
                    ClipOval(
                      child: Material(
                        color: lightGreen, // button color
                        child: InkWell(
                          splashColor: greenColor, // inkwell color
                          child: SizedBox(
                            width: 30,
                            height: 30,
