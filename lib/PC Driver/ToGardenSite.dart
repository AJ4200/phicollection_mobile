...
import 'PCDriverScanQR.dart';

class ToGS extends StatefulWidget {
  @override
  _ToGSState createState() => _ToGSState();
}

class _ToGSState extends State<ToGS> {
  ...
  final String _destinationAddress = request.pickupDest;
  ...
  String getHeading() {
    if(request.reported){
      return 'To Reported Truck'.toUpperCase();
    } else {
      return 'To Garden Site'.toUpperCase();
    }
  }
                ...
                child: Column(
                  ...
                  children: [
                    AppButton(
                      ...
                      child: Text('Scan QR Code'.toUpperCase(), style: boldTextStyle(color: Colors.white), ),
                      onTap: () {
                        const DriverQR().launch(context);
                      },
                      color: greenColor,
                      ...
                      child: Padding(
                        ...
                        child: Column(
                          ...
                          children: <Widget>[
                            Text(
                              getHeading(),
                              style: const TextStyle(fontSize: 25.0, fontWeight: FontWeight.w900, color: greenColor),
                            ),
                            5.height,
                            Visibility(
