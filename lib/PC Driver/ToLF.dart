...
import 'ToCentral.dart';

class ToLF extends StatefulWidget {
  @override
  _ToLFState createState() => _ToLFState();
}

class _ToLFState extends State<ToLF> {
  ...
  final String _destinationAddress = request.dropoffDest;
  ...
  String getHeading() {
    if(request.waste == "General Waste"){
      return 'To Landfill'.toUpperCase();
    } else {
      return 'To Recycling'.toUpperCase();
    }
  }

  void arrivedAtLan() async {
    bool arrived = await arrivedAtLandfill(request.requestNumber);
    if (arrived) {
      Navigator.of(context).push(MaterialPageRoute(
        builder: (context) => ToCentral(),
      ));
    }
  }
                ...
                child: Column(
                  ...
                  children: [
                    AppButton(
                      ...
                      child: Text('Confirm Drop-off'.toUpperCase(), style: boldTextStyle(color: Colors.white), ),
                      onTap: () {
                        confirmDropOff();
                      },
                      color: greenColor,
  ...
  confirmDropOff() {
    return showDialog(
      ...
      builder: (context) => AlertDialog(
        ...
        content: const Text("Did you drop off the waste?"),
        actions: <Widget>[
          TextButton(
            onPressed: arrivedAtLan,
            child: const Text(
              "Yes",
              style: TextStyle(
                color: Colors.black,
