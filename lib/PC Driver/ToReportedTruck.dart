...
class ToReportedTruck extends StatefulWidget {
  @override
  _ToReportedTruckState createState() => _ToReportedTruckState();
}

class _ToReportedTruckState extends State<ToReportedTruck> {
  ...
  String _destinationAddress = 'Marks Park Cricket Club';
  ...
  Future setShared() async{
    request = await SessionManager().get('request');
  }
                              ...
                              child: Column(
                                ...
                                children: [
                                  AppButton(
                                    ...
                                    child: Text('Confirm Bin Swap'.toUpperCase(), style: boldTextStyle(color: Colors.white), ),
                                    onTap: () {
                                      confirmDropOff();
                                    },
                                    color: greenColor,
  ...
  confirmDropOff() {
    return showDialog(
      ...
      builder: (context) => AlertDialog(
        title: const Text("Confirm Bin Swap"),
        content: const Text("Have you swapped the Bins?"),
        actions: <Widget>[
          TextButton(
            onPressed: () {ToLF().launch(context);},
            child: const Text(
              "Yes",
              style: TextStyle(
                color: Colors.black,
  ...
  AlertDialog confirmationPrompt() {
    return AlertDialog(
      backgroundColor: white,
      title: const Text("Confirmation"),
      content: const Text("Have you swapped the the Bins?"),
      actions: <Widget>[
        ListBody(
          children: [
            ElevatedButton(
